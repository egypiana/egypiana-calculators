...
export const metadata: Metadata = {
  ...
  description:
    "حوّل التاريخ بين الميلادي والهجري مجاناً. اعرف تاريخ اليوم بالهجري، وموعد رمضان وعيد الفطر وعيد الأضحى 2026. أداة التحويل الأدق.",
...
const faqs = [
  ...
  {
    question: "متى رمضان 2026؟",
    answer: "يُتوقع أن يبدأ شهر رمضان 1446 في أوائل مارس 2026 (تقريباً). تاريخه الدقيق يعتمد على الرؤية الشرعية ويختلف من دولة لأخرى.",
  },
  {
